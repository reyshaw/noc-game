...
export default {
  ...
  data () {
    return {
      imgURLS: [
        'http://172.16.135.103/ui/gfx_frontend/dome/billboard-testgame.jpg',
        'http://172.16.135.103/ui/gfx_frontend/dome/billboard-testgame.jpg',
        'http://172.16.135.103/ui/gfx_frontend/dome/billboard-testgame.jpg',
        'http://172.16.135.103/ui/gfx_frontend/dome/billboard-testgame.jpg',
        'http://172.16.135.103/ui/gfx_frontend/dome/billboard-testgame.jpg',
...
.wrapper{
  ...
  .content{
    width: 100%;
    overflow: hidden;
    background: url(http://172.16.135.103/ui/gfx_frontend/dome/testgame-lobby-content-bg.png) 0 0 no-repeat, linear-gradient(#070d19, #0a1323);
    background-size: 100%;
    .container{
      width: 1200px;
      margin: 35px auto;
