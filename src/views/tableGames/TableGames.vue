        ...
        <div class="container">
          <div class="chessPlatform" v-for="(item, index) in gamePicList" :key="index">
            ...
            <div class="layer">
              ...
              <button @click="enterGame(1396, platformIdList[0])">进入游戏</button>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  data () {
    return {
      ...
      imgURLS: [
        'http://172.16.135.103/ui/gfx_frontend/table_game/banner.png',
        'http://172.16.135.103/ui/gfx_frontend/table_game/banner.png',
        'http://172.16.135.103/ui/gfx_frontend/table_game/banner.png',
        'http://172.16.135.103/ui/gfx_frontend/table_game/banner.png',
        'http://172.16.135.103/ui/gfx_frontend/table_game/banner.png'
            ...
            .swiper-slide{
              .btm{
                ...
                ::after{
                  ...
                  height: 10px;
                  border-radius: 20px;
                  box-shadow: 0px 80px 20px 1px $--color-text-primary;
